...
ARCHITECTURE behavioral OF rx_fsm IS
    ...
    SIGNAL resync_state : std_logic := '1';
...
BEGIN
    strobe_gen : ENTITY work.strobe_generator_rx(behavioral) PORT MAP (clk => clk, baud_rate => baud_rate, resync => resync_state, strobe_sampler => strobe_sampler, strobe_fsm => strobe_fsm, error => strobe_error);
