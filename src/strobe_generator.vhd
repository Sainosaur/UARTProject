...
ARCHITECTURE behavioral OF strobe_generator IS
    ...
    SIGNAL rx_counter: unsigned(3 DOWNTO 0) := (OTHERS => '0');
    SIGNAL baud_rate_counters: baud_rate_array := ("00110100", "00011010", "00001101", "00000110", "00000011", "00000000", "00000000", "00000000");
BEGIN
    PROCESS (clk)
    BEGIN
        IF rising_edge(clk) THEN
            IF tx_counter < baud_rate_counters(baud_rate) THEN
                enable_tx <= '0';
